...
var getTemplate = function getTemplate() {
  ...
  var text = placeholder !== null && placeholder !== void 0 ? placeholder : 'Выбери элемент';
  var cls = '';
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function select(id) {
      ...
      this.element.querySelectorAll('[data-type="item"]').forEach(function (item) {
...
window.check = select;
},{"../js/select":"../js/select.js","../css/style.scss":"../css/style.scss"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
